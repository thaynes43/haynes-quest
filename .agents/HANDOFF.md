...
Tom is comparing one-year levels with levels covering a percentage of the available history, and requested enemies tailored for different genders. DESIGN-004 recommends up to ten chapters adjusted for usable photos and selectable enemy themes with overridable presets. These are proposals: chapter policy is unaccepted, and the question of whose gender/preferences selects enemies has been asked and is awaiting his answer. Difficulty remains separate from subject age and enemy theme.
