...
**September 23 asset priority:** PLAN012 and the world builder are released. Tom now requests a full original spooky animatronic parody lineup, Rat Casino and Haynesnightmares, with Blender models before more levels. The previous one-entry-at-a-time cost guard does not reduce his requested full cast. Tom inspected the first six-character concept and directed a central lead rat, Chick-flia as a side character and stronger haunted mascot energy; the v002 construction reference records this before character modeling. Environment candidates may proceed on a coordinator-selected concept. Preserve the older arcade/toybox versions and every exact owner-art gate. [PLAN015](plans/015-haynesnightmares-asset-first.md) and [DESIGN012](../docs/designs/012-player-journey-curation.md) record the current stage.
...
Tom's September 11 correction superseded unattended completion of the former fixed enemy batch. The Besties duo was delivered as a private playtest candidate using the approved joint look. Tom's September 23 direction now makes the full FNAF-esque original parody cast the active asset pass. Tom liked that pitch and gave specific hierarchy and mood feedback, recorded in the v002 review. Expensive character rig/model production is now authorized as a candidate pass, one exclusive Blender scene author at a time. Exact exported art remains subject to Tom’s final review before gameplay use. This does not hold independent environment asset modeling, catalog work, tests or ordinary checked PRs. Preserve and release every Blender scene safely. See [DESIGN-012](../docs/designs/012-player-journey-curation.md).
