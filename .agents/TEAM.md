...
**September 23 asset priority:** PLAN012 and the world builder are released. Tom now requests a full original spooky animatronic parody lineup, Rat Casino and Haynesnightmares, with Blender models before more levels. The previous one-entry-at-a-time cost guard does not reduce his requested full cast; it still requires him to inspect the selected concept/look before expensive character modeling. Environment candidates may proceed on a coordinator-selected concept. Preserve the older arcade/toybox versions and every exact owner-art gate. [PLAN015](plans/015-haynesnightmares-asset-first.md) and [DESIGN012](../docs/designs/012-player-journey-curation.md) record the current stage.
...
Tom's September 11 correction superseded unattended completion of the former fixed enemy batch. The Besties duo was delivered as a private playtest candidate using the approved joint look. Tom's September 23 direction now makes the full FNAF-esque original parody cast the active asset pass. The lead has shown a concrete lineup pitch and asked for feedback on its look and scope; expensive character rig/model production follows that answer. This does not hold independent environment asset modeling, catalog work, tests or ordinary checked PRs. Preserve and release every Blender scene safely. See [DESIGN-012](../docs/designs/012-player-journey-curation.md).
