...
3. The Besties retain their alternating tricks and missed high-five animation. Primary and Secondary can damage them in every active phase when equipped, ready and in range. Keep ordinary encounter prerequisites and authoritative damage/cooldown rules. Verify a fresh second playthrough and death retry independently.
