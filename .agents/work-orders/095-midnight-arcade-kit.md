...
The reviewed catalog and all three exact GLBs are published at the private [asset studio](https://haynes-quest-playtest.haynesops.com/studio/assets/reviews/midnight-arcade-kit/v001.html). The live review, concept and model files returned 200 with hashes matching the checked source; desktop/phone catalog audit passed. [Release record](../evidence/world-builder-release.json). Tom's exact-version decision is still pending.
