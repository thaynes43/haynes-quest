...
2. **Signal Moth**, selected concept at `docs/assets/media/signal-moth/v001/concept.png`: a low-hovering walnut/brass moth with four broad segmented leaf-shaped wings and luminous inset panels, antennae, no screen logo. Total posed height 0.9 m, wingspan 1.25 m.
3. **Buffer Baron**, selected concept at `docs/assets/media/buffer-baron/v001/concept.png`: 1.85 m floating wooden lantern boss, broad pear-shaped body, carved mask with inset eyes, a segmented brass loading halo and two articulated arms. A large readable wind-up before its radial pulse attack.
