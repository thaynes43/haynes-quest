...
| `magic-house/v001` | Blender reference sheet, no generated concept; coordinator approved September 26 | Completed by a Claude Opus 5.5 Blender author on `blender-authoring-2`; coordinator intake and exact checks pass | [PR99](https://github.com/thaynes43/haynes-quest/pull/99) | 2.51 m wide × 2.898 m tall to the hopping ridge tile (2.80 m solid) × 1.98 m deep; thrown tiles reach 2.10 m in front. 12,122 triangles, 32 joints, 1.25 s contact. Shimmy/hop tile-throw attack and sheepish-slump defeat per the sheet notes. Scene released; 129 matching artifact hashes; Three.js adapter check rerun at intake. Catalog publication pending. |
