...
Inspect the actual selected sheets in [the concept review](../../docs/assets/reviews/era-combat/v001.md) before constructing each model. These original period interpretations share walnut, honey brass, sage and plum with the existing traveler and clearing kit. Preserve the craftsmanship and readable silhouette; simple default primitive figures are not an acceptable replacement.

1. Loop Dancer: 1.10 m tall, two arms and two legs, a winding key and two cloth scarf tails. Articulated dance motion with a clear wind-up, readable attack, hit response and collapse.
2. Prism Mimic: 1.05 m to ear tips, four feet, one tail and faceted amber/plum mask panels. Low four-footed locomotion, a readable forward attack and distinct hit/defeat poses. No second face on the back.
3. Trendweaver: 1.90 m hovering boss, five crown arches, two arms, two ribbon tails and three bottom bobbins. Shuttle in the left hand. Large winding motion before the pulse attack; full readable silhouette from the player's camera.
