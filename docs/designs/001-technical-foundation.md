...
| Q-04 | Which photos are eligible, and what progress does collection record? | Photo integration | Configured connection, people, and chronological memory collection are established. Exact filters, decade/proportional grouping, chapter completion, and refresh behavior remain for design. See DESIGN-003 and DESIGN-004; [DESIGN-005](005-era-enemy-catalog.md) defines the era-based enemy/boss contract. |
