...
Actual Authentik admission, real-person age policy, source revocation, physical Safari checks and owner approval of integrated artwork are separate acceptance boundaries. The earlier deployed fixture and its technical tests remain historical evidence; [PLAN-005](../../.agents/plans/005-era-combat-loop.md) and the [handoff](../../.agents/HANDOFF.md) state what the corrected game has actually completed.
