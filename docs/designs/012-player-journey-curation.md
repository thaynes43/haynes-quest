...
**September 23 direction:** Tom now asks for a full Five Nights at Freddy's-esque parody lineup, a spooky retro Rat Casino and a Halloween Haynesnightmares theme. The earlier Midnight Arcade treatment reads too young; the arcade theme itself is in the right direction. He prioritizes Blender character models before building levels. The [six-character visual pitch](../assets/reviews/rat-casino-ensemble/v001.md) is the first concrete proposal, not a ruling that “full lineup” means exactly six or approval of its look. Tom has been asked to review that sheet before the character modeling stage. The cast remains original game art; any eventual date eligibility, encounter behavior, asset readiness and gameplay use still follow DESIGN005 and DESIGN002.
