...
**September 23 direction:** Tom now asks for a full Five Nights at Freddy's-esque parody lineup, a spooky retro Rat Casino and a Halloween Haynesnightmares theme. The earlier Midnight Arcade treatment reads too young; the arcade theme itself is in the right direction. He prioritizes Blender character models before building levels. The [six-character v001 pitch](../assets/reviews/rat-casino-ensemble/v001.md) established the cast but not an exact roster limit or approved look. Tom chose the rat as central lead and Chick-flia as a side character, then rejected [v002's glam-rock finish](../assets/reviews/rat-casino-ensemble/v002.md). The [v003 classic-mascot concept](../assets/reviews/rat-casino-ensemble/v003.md) is the current coordinator-selected modeling reference; candidate character modeling may proceed one Blender scene author at a time. The cast remains original game art; any eventual date eligibility, encounter behavior, asset readiness and gameplay use still follow DESIGN005 and DESIGN002.
