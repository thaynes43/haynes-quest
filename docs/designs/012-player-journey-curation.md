...
Tom selected **The Besties duo first** in the September 11 follow-up. Tom then approved a duo boss with alternating obstacle tricks and a shared recovery window. [The agreed routine and reference limits](../../.agents/work-orders/036-besties-design-brief.md) are recorded before visual production.

**September 23 direction:** Tom selected a full Five Nights at Freddy's-esque parody lineup, a spooky retro Rat Casino and a Halloween Haynesnightmares theme. The earlier Midnight Arcade treatment read too young; the arcade theme itself was in the right direction. He put Blender character models before building levels. The [six-character v001 pitch](../assets/reviews/rat-casino-ensemble/v001.md) established the cast; Tom chose the rat as central lead and Chick-flia as a side character, then rejected [v002's glam-rock finish](../assets/reviews/rat-casino-ensemble/v002.md). The [v003 classic-mascot concept](../assets/reviews/rat-casino-ensemble/v003.md) guided six separate Blender candidates, now published in the private studio under [completed PLAN015](../../.agents/plans/completed/015-haynesnightmares-asset-first.md) and its [release record](../../.agents/evidence/classic-cast-release.json). [PLAN014](../../.agents/plans/014-complete-world-builder.md) remains open for the first Rat Casino level. The cast remains original game art; date eligibility, encounter behavior and gameplay use still follow DESIGN005 and DESIGN002 and require Tom's exact-version art review.
