...
World B (`family-world-b@v1`, "Playroom to Big Stage") follows the same pattern:
...
- `pnpm exec tsx scripts/levels/build-family-world-b.ts --write` rewrites `scripts/levels/family-world-b.commands.json` and `src/shared/levels/family-world-b-v1.json`.
