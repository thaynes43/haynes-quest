...
| Architecture decisions | Significant choices and their tradeoffs | [ADR-001: Authentik sign-in](adrs/001-authentik-sign-in.md), [template](adrs/000-template.md) |
...
| Plans | Executable work and evidence of completion | [Completed bootstrap plan](../.agents/plans/completed/001-repository-bootstrap.md), [template](../.agents/plans/000-template.md) |
