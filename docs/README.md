...
| Work orders and asset reviews | Bounded Sol tasks under Astra and exact-version owner review | [Work-order template](../.agents/work-orders/000-template.md), [Asset-review template](assets/000-review-template.md) |
