...
// Run from this checkout: node docs/assets/media/rat-casino-kit/v001/browser-intake.mjs
...
const server=http.createServer(async(request,response)=>{
  ...
  try{
    if(url.pathname==='/'){
      ...
      response.end(`<!doctype html><html><head><meta charset="utf-8"><style>html,body{margin:0;width:100%;height:100%;background:#302736}model-viewer{width:100%;height:100%}</style><script type="module" src="/model-viewer.mjs"></script></head><body><model-viewer src="/${name}.glb" alt="WO097 technical model check" camera-controls interaction-prompt="none" environment-image="neutral" exposure="1" shadow-intensity=".8" camera-orbit="148deg 70deg auto"></model-viewer></body></html>`);
...
try{
  ...
  const report={workOrder:'WO097',browser:browser.version(),viewer:'model-viewer 4.3.1 (bundled, Three.js-based)',
