/** WO111 magic-house author review helper: exact-GLB close-ups at arbitrary cameras/poses (not delivery evidence).
 * node look.mjs <glb> <outdir> '<json {name:{pos,target,half,clip,time}}>' */
