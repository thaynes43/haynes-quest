...
**Validated Blender model candidate · Private Rat Casino playtest boss · Final device/art review pending.** Rat Pit Boss is the central performer in the proposed six-character Rat Casino cast. Tom asked for the quieter, worn feel of the original 2014 FNAF setting after the earlier images looked too glam rock. This separate v002 model follows the [corrected ensemble](../rat-casino-ensemble/v003.md) and [rat construction sheet](../../media/rat-casino-ensemble/v003/construction/rat-pit-boss.png). The [first glossy rigged export](v001.md) remains a paused, unvalidated checkpoint.

[Construction image prompt](../../media/rat-casino-ensemble/v003/construction/rat-pit-boss-prompt.txt) · [Image source and checksums](../../media/rat-casino-ensemble/v003/source.json)
...
The browser check used software Chromium. Physical iPad/iPhone Safari, device frame time and combat feel remain untested. This exact `v002` GLB is pinned as the **boss in the private fictional Rat Casino playtest**, following Tom's September 23 “Looks great, let’s move forward” direction. Its SHA-256 is `2f41912e67ba27f7f1d5a6c8ac7bc60fbe8d3dba6e4a775f7186750f608b620d`. Final art acceptance follows the live level and device review.
