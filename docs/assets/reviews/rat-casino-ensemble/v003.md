...
- **Blender models:** The v001 Rat Pit Boss first rigged export was paused before final validation when the look changed. Separately authored [corrected Rat Pit Boss v002](../rat-pit-boss/v002.md) and [Chick-flia v001](../chick-flia/v001.md) models passed technical checks and await Tom's exact-version art review. Each remaining supporting model needs its own versioned review and technical evidence.
