...
- **Gameplay use:** Rat Pit Boss leads five frozen encounters with Chick-flia, Jackrabbit, Fox and Moth as the four ordinary roles. Golden is an idle, noncombat stage cameo. The concept image itself is reference art; the GLBs are pinned on their individual review pages.
