...
- **Blender models:** The v001 Rat Pit Boss first rigged export was paused before final validation when the look changed. A separately authored [corrected v002 model](../rat-pit-boss/v002.md) passed technical checks and awaits Tom's exact-version art review. Each supporting model needs its own versioned review and technical evidence.
