...
**Friendly character.** A glowing guide who helps travelers feel at home. Its friendly greeting can restore two hearts. Harming this character costs hearts and pauses its help; make amends to restore the friendship. This role is included in the PLAN006 playtest candidate. Final artwork review remains separate.
...
Choose **idle**, **move**, **attack**, **hit** or **defeat** beneath the viewer. Idle and movement repeat; the other actions play once. The root stays fixed, with movement supplied by the game. The attack reaches its contact pose at 0.70 s of a 1.25 s attack. Defeat finishes in a collapsed or drooping pose which the game holds until the player makes amends.
