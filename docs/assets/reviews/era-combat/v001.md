...
These eight concept sheets define six friendly residents and four useful tools for the playable journey. The lead selected them for construction on September 11, 2026. They share carved walnut, honey brass, sage and plum with the existing traveler and clearing kit.

**Friendly characters and equipment.** These construction sheets cover the six friendly residents and four useful tools. The residents offer healing when greeted; harming them carries a recoverable penalty. Their individual pages show the exact models, animation and source records. Final artwork review remains separate from this gameplay role.
...
A carved puppet with two arms, two legs, a winding key and two flowing scarf tails. Its winding motion and scarf flourishes give it a lively greeting. Full height: 1.10 m.
...
Actual exports and all five clips are available for [Blockling](../blockling/v001.md), [Signal Moth](../signal-moth/v001.md), [Buffer Baron](../buffer-baron/v001.md), [Loop Dancer](../loop-dancer/v001.md), [Prism Mimic](../prism-mimic/v001.md) and [Trendweaver](../trendweaver/v001.md). [The equipment page](../era-equipment/v001.md) contains four models and rear shield views. All authoring leases and render jobs have finished. The six residents provide optional healing in the private playtest. Their exact exported artwork still awaits final review.
