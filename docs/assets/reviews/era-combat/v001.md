...
[WO-014](../../../../.agents/work-orders/014-blender-era-2020.md) records the failed required native Astra authoring dispatch: the task’s agent limit prevented an author from starting. No Blender scene was changed. Next authoring must preserve these references, construct and animate the actual models, inspect re-imported exports and deliver exact-version review packages. Equipment needs measured grips and attachment transforms; enemies need readable idle, movement, attack, hit and defeat clips. The lead must then assess actual game captures before claiming visual acceptance.
