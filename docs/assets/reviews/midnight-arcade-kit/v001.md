...
- **Use:** Cabinet and bollard: private family world scenery (`family-world-a@v1` decor) since PLAN-019; this records use, not approval. Ticket arch: asset studio only. Other private playtest courses still use procedural arcade scenery. Changed geometry or materials need a new candidate version before approval or integration.
