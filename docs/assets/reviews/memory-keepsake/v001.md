...
PLAN008 keeps this model unchanged. Walking into a released route memory collects it; its keepsake then disappears from the playtest scene immediately. The picture remains in the memory album.
...
<figure><img src="../../media/memory-keepsake/concept-v002/concept.png" alt="Corrected concept with the rear wedge visible in the back view"><figcaption>Concept v002: the back view now includes the rear support.</figcaption></figure>
...
The 0.65 m frame carries a clear fictional tree picture above its lower rail. Tom spotted that the original concept omitted the wedge from its back view. The corrected illustration above adds it; the existing v001 model already has a broad central rear support. The model simplifies carved wood grain and tiny fasteners into broad matte forms.
...
[Corrected full-size concept](../../media/memory-keepsake/concept-v002/concept.png) · [Correction prompt](../../media/memory-keepsake/concept-v002/prompt.txt) · [Width revision prompt](../../media/memory-keepsake/concept-v002/revision-prompt.txt) · [Correction provenance](../../media/memory-keepsake/concept-v002/provenance.json)

[Original construction concept](../../media/memory-keepsake/v001/concept.png) · [Original prompt](../../media/memory-keepsake/v001/prompt.txt) · [Original concept provenance](../../media/memory-keepsake/v001/concept-provenance.json) · [Exact asset manifest](../../media/memory-keepsake/v001/manifest.json) · [Authoring work order](../../../../.agents/work-orders/010-blender-clearing-kit.md)
...
**September 11 feedback:** the wedge was missing from the concept’s back view. Concept v002 corrects that omission. An independent inspection of the exact v001 GLB confirmed its centered wedge reaches the ground and meets the rear board; no model revision was needed. [Correction record](../../../../.agents/work-orders/012-keepsake-wedge-reference.md).
