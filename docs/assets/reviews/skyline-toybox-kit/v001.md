...
- **Use:** Private family world scenery (`family-world-a@v1` and `family-world-b@v1` decor) since PLAN-019; this records use, not approval. Other private playtest courses still use procedural toybox scenery. Changed geometry or materials need a new candidate version before approval or integration.
