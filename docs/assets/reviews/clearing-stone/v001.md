...
- **Integration:** The exact v001 model is placed as scenery in the private family world template Clubhouse to Casino (`family-world-a@v1`, PLAN-019): the stone (6 placements each in The Toon Clubhouse and Harbor Rescue). This records use, not approval. The other private playtest courses use temporary shapes. Changed geometry or materials require a new candidate version before approval or use.
