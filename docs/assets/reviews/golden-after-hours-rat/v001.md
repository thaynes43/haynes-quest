...
The browser check used software Chromium. Physical iPad/iPhone Safari, device frame time and combat feel remain untested. This model is a **studio candidate only**, with no level or gameplay mapping. Final use still depends on Tom's review of this exact version and the later date-eligibility, encounter and device gates.
