...
The [Rat Casino ensemble v003](reviews/rat-casino-ensemble/v003.md) shows the corrected six-character classic mascot lineup with the rat at center and Chick-flia beside him. Earlier glossy versions remain linked as superseded history. The [Rat Pit Boss v002 Blender candidate](reviews/rat-pit-boss/v002.md) has an exact interactive model and five checked motions; its first v001 export is preserved as a paused, unvalidated checkpoint. Tom's review of the corrected model remains open. No Rat Casino character model is in gameplay.
