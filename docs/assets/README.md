...
The [Rat Casino ensemble v003](reviews/rat-casino-ensemble/v003.md) shows the corrected six-character classic mascot lineup with the rat at center and Chick-flia beside him. Earlier glossy versions remain linked as superseded history. The [Rat Pit Boss v002](reviews/rat-pit-boss/v002.md), [Chick-flia v001](reviews/chick-flia/v001.md), [Jackrabbit Drummer v001](reviews/jackrabbit-drummer/v001.md) and [Fox Card Shark v001](reviews/fox-card-shark/v001.md) Blender candidates have exact interactive models and five checked motions each; the rat's first v001 export is preserved as a paused, unvalidated checkpoint. Tom's review of all four corrected model versions remains open. No Rat Casino character model is in gameplay.
