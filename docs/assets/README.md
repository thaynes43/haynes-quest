...
The common reference set, both traveler models and all four sound auditions are available. The clearing prop kit is in production alongside the private playable preview. Infrastructure test meshes and sounds are not game candidates or approved assets.
