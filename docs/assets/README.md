...
The [Rat Casino ensemble v003](reviews/rat-casino-ensemble/v003.md) shows the corrected six-character classic mascot lineup with the rat at center and Chick-flia beside him. Earlier glossy versions remain linked as superseded history. The [Rat Pit Boss v002](reviews/rat-pit-boss/v002.md), [Chick-flia v001](reviews/chick-flia/v001.md), [Jackrabbit Drummer v001](reviews/jackrabbit-drummer/v001.md), [Fox Card Shark v001](reviews/fox-card-shark/v001.md), [Moth Projectionist v001](reviews/moth-projectionist/v001.md) and [Golden After-Hours Rat v001](reviews/golden-after-hours-rat/v001.md) Blender candidates each have an exact interactive model and five checked motions; the lead rat's first v001 export is preserved as a paused, unvalidated checkpoint. The current private Rat Casino route uses the five required characters and Golden as an optional fight. Tom's final review of all six corrected model versions remains open.
