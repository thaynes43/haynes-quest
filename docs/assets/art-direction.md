...
Tom liked the [first six-character lineup sheet](reviews/rat-casino-ensemble/v001.md) and directed the rat to lead from center stage, Chick-flia to support from the side, and the mood to move closer to haunted animatronic stage horror. The [v002 cast sheet](reviews/rat-casino-ensemble/v002.md) is the active construction reference. Keep the Rat Pit Boss larger and more commanding than the other performers; make the golden after-hours rat visibly different. The [three-prop Rat Casino sheet](media/rat-casino-kit/v001/concept.png) supplies the set pieces. Concept images do not constitute finished 3D assets. Review each exact model separately and retain the older arcade and toybox kits as studio history.
