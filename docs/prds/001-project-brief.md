...
| Q-11 | Which audio tool should the Astra team use? | Audio authoring setup | Tom asked about free and self-hosted options. DESIGN-008 now recommends a Stable Audio Small-SFX CPU trial with ElevenLabs as an optional hosted alternative. Asked Tom which trial to prepare; selection/access remain pending. FFmpeg and Web Audio remain shared parts of the workflow. No model access, generation quality, or speed has been tested. |
