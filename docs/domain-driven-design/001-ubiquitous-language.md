...
| T-08 | Saved game | One player's resumable game, retaining the selected subject, journey definition, chapter, collected-memory progress, and selected enemy/boss encounters. A player may have multiple saved games. |
