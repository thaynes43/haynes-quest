...
const names=process.argv.slice(4);if(!names.length)names.push('sir-flush-a-lot','nap-captain','one-star-diva');
const specs={'sir-flush-a-lot':[1,0,null],'nap-captain':[1.05,0,null],'one-star-diva':[1.65,0,null]};
let failed=false;
