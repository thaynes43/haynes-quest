"""WO111 rival-mayor v001: upload a local source file and execute it through the Blender MCP route.
...
class MCP:
    def __init__(self):
        ...
        self.call('initialize', {'protocolVersion': '2024-11-05', 'capabilities': {}, 'clientInfo': {'name': 'wo111-rival-mayor', 'version': '1'}})
...
if __name__ == '__main__':
    client = MCP()
    guard = ("import bpy; sc=bpy.context.scene; assert sc.get('work_order')=='WO111' and sc.get('asset_id')=='rival-mayor' "
