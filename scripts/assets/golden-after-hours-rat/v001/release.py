...
lease=json.loads((ROOT/'scene-claim.json').read_text())
...
sc['candidate_status']='WO104 v001 validated studio candidate. Lead visual review passed; Tom exact-version art and later gameplay/device gates remain pending.'
