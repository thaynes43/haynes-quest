/** Exact-byte Khronos validation and WO-028 resource/clip contract. */
...
const root=process.argv[2]||'/workspace/haynes-quest/parody/block-party-pair/v001';
const names=process.argv.slice(3);if(!names.length)names.push('peel-patrol','drama-dragon');
let failed=false;
