...
client=MCP()
client.execute("import bpy; assert bpy.context.scene.get('work_order')=='WO111' and bpy.context.scene.get('scene_lease')=='active' and bpy.context.scene.get('asset_id')=='yes-yes-veggie'")
