/** WO099 exact GLB Chromium stills and later motion sampling; no shared browser. */
...
try{
 ...
 for(const clip of ['idle','move','attack','hit','defeat']){
  ...
  for(const [col,fraction] of [0,.3,.625,1].entries()){
   ...
   const label=Buffer.from('<svg width="320" height="36"><rect width="320" height="36" fill="#211f25"/><text x="12" y="24" fill="#e3dccb" font-size="17" font-family="sans-serif">'+clip+' · '+Math.round(fraction*100)+'%</text></svg>');
