"""WO-014 views and motion rendered from exact re-imported GLBs.
...
def render(output,name,quick=False,stills=False,video=False):
    ...
    h={'blockling':.85,'signal-moth':.9,'buffer-baron':1.85}[name]
    scale={'blockling':1.12,'signal-moth':1.68,'buffer-baron':2.50}[name]
    target=(0,0,h*.50)
...
if __name__=='__main__':
    ...
    parser.add_argument('--output',default='/workspace/haynes-quest/era-2020/v001')
