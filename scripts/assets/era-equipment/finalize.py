...
def finalize():
    ...
    result = {'schema_version': 1, 'work_order': 'WO-017', 'version': 'v001', 'author': 'native gpt-6-astra, max', 'candidate_status': 'unapproved', 'coordinator_review': 'pending', 'tom_review': 'pending', 'asset_root': 'haynes-quest/era-equipment/v001', 'assets': {}}
    for name in NAMES:
        ...
        for file in sorted(folder.iterdir()):
            if file.name == 'manifest.json' or not file.is_file(): continue
